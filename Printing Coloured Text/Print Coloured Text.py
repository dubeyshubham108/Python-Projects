...
print(Fore.BLUE+Back.YELLOW+"Hi My name is Shubham Dubey "+ Fore.YELLOW+ Back.GREEN+"I am learning Machine Learning")
print(Back.CYAN+"I love coding ")
print(Fore.YELLOW + Back.BLUE+ "Coding is now my new hoppy.")
